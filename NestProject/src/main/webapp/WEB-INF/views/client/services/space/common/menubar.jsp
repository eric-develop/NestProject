	...
	<ul	class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion"
		...
		<li class="nav-item dropdown no-arrow">
			...
			<a class="nav-link dropdown-toggle" href="#" id="userDropdown"
				...
				aria-expanded="false" style="width:130px; margin:0px;"> 
					<img class="img-profile rounded-circle"	src="https://source.unsplash.com/QAB-WJcbgJk/60x60">
					<span class="mr-2 d-none d-lg-inline text-white-600 small">${member.nickName}</span>
			</a> 
		<!-- 메신저 아이콘 -->
		...
		<div class="popupLayer">
			...
			<div id="msg_parent">
			 ...
			 <div id="chattingContainer" style="display:none;">	
   			   <div id="chatNav" style="background:rgb(169,189,209); position:relative; width:393px;height:55px; margin-left:5px;"><div id="friend_img"class="rounded-circle" style="padding-bottom:10px; margin: 0px 0px 0px 10px; width:45px; height:45px;"></div><p id="receiver"></p></div>
	      	   ...
	      	   <div id="msgInputBox" style="position:relative; width:385px; height:95px; background:white;margin-left:11px;">
		     		<div>
		      			<textArea id="msgContent" style="width:275px; height:90px; background:white; border:none;"></textArea>
		      			<div style="float:right; "><button class="btn btn-warning" id="sendMsg" style="background:rgb(255,236,66); width:60px; margin: 5px 15px 0px 5px">전송</button></div>
		      		</div>
	           </div>
